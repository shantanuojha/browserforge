...
| `AlarmsPort`, `SettingsStore`, `BackupStatusStore`     | arbor `lib/background/ports.ts`                                     | `adapters/alarms.ts`, `adapters/settings-store.ts`, `adapters/backup-status-store.ts`                 |
